...
*
* Description: QuantumLiquids/DMRG project. MPI Lanczos algorithm unittests.
*/
...
int main(int argc, char *argv[]) {
  ...
  if (rank == 0) {
    ...
    auto lanczos_res = MasterLanczosSolver(eff_ham, initial_state, params, comm);
    ...
    std::vector<DQLTensor *> eff_ham = SlaveLanczosSolver<DQLTensor>(comm);
